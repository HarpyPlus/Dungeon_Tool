...
if (InFileBounds) {
	switch (room) {
		...
		case (Rm_PlrEditor) :
			...
			//New                  Y-33      Y+5
			draw_rectangle_color(4, 52, 434, 90, FirstSelCol, FirstSelCol, FirstSelCol, FirstSelCol, false); //New Sel box
			draw_text_transformed_color(50, 85, "New                                 (Ctrl + N)", 1, 1, 0, c_black, c_black, c_black, c_black, 1);
			//Open                 Y-29      Y+5
			draw_rectangle_color(4, 91, 434, 125, SeconSelCol, SeconSelCol, SeconSelCol, SeconSelCol, false); //Open Sel box
			draw_text_transformed_color(50, 120, "Open                               (Ctrl + O)", 1, 1, 0, c_black, c_black, c_black, c_black, 1);
			//Open                 Y-29      Y+5
			draw_rectangle_color(4, 126, 434, 160, ThirdSelCol, ThirdSelCol, ThirdSelCol, ThirdSelCol, false); //Recent Sel box
			draw_text_transformed_color(50, 155, "Recent Files                                    >>", 1, 1, 0, c_maroon, c_maroon, c_red, c_red, 1);
			//Save
			if (global.spriteLoaded) {
				//                      Y-29      Y+5
				draw_rectangle_color(4, 176, 434, 210, FourtSelCol, FourtSelCol, FourtSelCol, FourtSelCol, false); //Recent Sel box
			}
			...
			//Close                 Y-29      Y+5
			draw_rectangle_color(4, 226, 434, 260, FifthSelCol, FifthSelCol, FifthSelCol, FifthSelCol, false); //Recent Sel box
			draw_text_transformed_color(50, 255, "Close", 1, 1, 0, c_black, c_black, c_black, c_black, 1); //Print File
			//Exit                  Y-29      Y+5
			draw_rectangle_color(4, 261, 434, 295, SixthSelCol, SixthSelCol, SixthSelCol, SixthSelCol, false); //Recent Sel box
