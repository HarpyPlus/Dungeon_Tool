	...
	case (Rm_PlrEditor) :
		if (global.spriteLoaded) {
			if (sprite_exists(Obj_Preview.sprite_index)) {
				switch (ScaleDown) {
					case true :
						draw_sprite_part_ext(Obj_Preview.sprite_index, Obj_Preview.image_index, 0, 0, 16, 16, x + 56, y + 56, (14 / 2), (14 / 2), c_white, 1);
						draw_text_transformed_color(x, y - 4, "[32x32]", 1, 1, 0, c_white, c_white, c_white, c_white, 1);
						break;
					default :
						draw_sprite_part_ext(Obj_Preview.sprite_index, Obj_Preview.image_index, 0, 0, 16, 16, x, y, (14 / 1), (14 / 1), c_white, 1);
